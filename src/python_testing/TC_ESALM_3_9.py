...
ALARM_NAME = "PowerImport"
ALARM_BIT = int(AlarmBitmap.kPowerImported)


class TC_ESALM_3_9(ElectricalAlarmTestBaseHelper):

    def pics_TC_ESALM_3_9(self) -> list[str]:
    ...
    async def test_TC_ESALM_3_9(self):
        """[TC-ESALM-3.9] PowerImport alarm lifecycle with Server as DUT

        Verifies the lifecycle of the PowerImport alarm: the condition sets its bit in State and
